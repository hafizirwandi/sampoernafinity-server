            ...
            >
                ...
                <nav class="flex-1 space-y-1 overflow-y-auto overflow-x-hidden px-3 py-4">
                    <a
                        ...
                        class="flex items-center gap-3 rounded-lg px-3 py-2 text-sm font-medium {{ request()->routeIs('dashboard') ? 'bg-primary-600 text-white' : 'text-text-muted hover:bg-surface-alt hover:text-text' }}"
                    >
