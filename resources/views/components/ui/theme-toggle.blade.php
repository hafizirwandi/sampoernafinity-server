...
<button
    ...
    {{ $attributes->merge(['class' => 'inline-flex items-center justify-center rounded-lg border border-border p-2 text-text-muted hover:bg-surface-alt hover:text-text ' . $class]) }}
>
    ...
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" class="hidden h-5 w-5 dark:block">
